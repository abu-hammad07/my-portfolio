            ...
            <div class="row">
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-widget w-100">
                        <div class="dash-widgetimg">
                            <span><img src="{{ url('public/img/icons/dash1.svg') }}" alt="img"></span>
                        </div>
                ...
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-widget dash1 w-100">
                        <div class="dash-widgetimg">
                            <span><img src="{{ url('public/img/icons/dash2.svg') }}" alt="img"></span>
                        </div>
                        <div class="dash-widgetcontent">
                ...
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-widget dash2 w-100">
                        <div class="dash-widgetimg">
                            <span><img src="{{ url('public/img/icons/dash3.svg') }}" alt="img"></span>
                        </div>
                        <div class="dash-widgetcontent">
                ...
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-widget dash3 w-100">
                        <div class="dash-widgetimg">
                            <span><img src="{{ url('public/img/icons/dash4.svg') }}" alt="img"></span>
                        </div>
                        <div class="dash-widgetcontent">
                ...
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-count das2">
                        ...
                        <div class="dash-imgs">
                            <img src="{{ url('public/img/icons/file-text-icon-01.svg') }}" class="img-fluid"
                                alt="icon">
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table dashboard-recent-products">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="productimgname">
                                                <a href="{{ url('product-list') }}" class="product-img">
                                                    <img src="{{ url('public/img/products/stock-img-01.png') }}"
                                                        alt="product">
                                                </a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="productimgname">
                                                <a href="{{ url('product-list') }}" class="product-img">
                                                    <img src="{{ url('public/img/products/stock-img-06.png') }}"
                                                        alt="product">
                                                </a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="productimgname">
                                                <a href="{{ url('product-list') }}" class="product-img">
                                                    <img src="{{ url('public/img/products/stock-img-02.png') }}"
                                                        alt="product">
                                                </a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="productimgname">
                                                <a href="{{ url('product-list') }}" class="product-img">
                                                    <img src="{{ url('public/img/products/stock-img-03.png') }}"
                                                        alt="product">
                                                </a>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="productimgname">
                                            <a href="javascript:void(0);" class="product-img stock-img">
                                                <img src="{{ url('public/img/products/expire-product-01.png') }}"
                                                    alt="product">
                                            </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="productimgname">
                                            <a href="javascript:void(0);" class="product-img stock-img">
                                                <img src="{{ url('public/img/products/expire-product-02.png') }}"
                                                    alt="product">
                                            </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="productimgname">
                                            <a href="javascript:void(0);" class="product-img stock-img">
                                                <img src="{{ url('public/img/products/expire-product-03.png') }}"
                                                    alt="product">
                                            </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="productimgname">
                                            <a href="javascript:void(0);" class="product-img stock-img">
                                                <img src="{{ url('public/img/products/expire-product-04.png') }}"
                                                    alt="product">
                                            </a>
