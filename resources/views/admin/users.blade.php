                        ...
                        <div class="search-path">
                            <div class="d-flex align-items-center">
                                <a class="btn btn-filter" id="filter_search">
                                    ...
                                    <span><img src="{{ url('public/img/icons/closes.svg') }}" alt="img"></span>
                                </a>
                            </div>
                        </div>
                        <div class="form-sort">
                            ...
                            <tbody>
                                @foreach ($getRecord as $record)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="userimgname">
                                                <a href="javascript:void(0);" class="userslist-img bg-img">
                                                    <img src="{{ url('public/img/users/user-23.jpg') }}" alt="product">
                                                </a>
                                                <div>
                                        ...
                                        <td>
                                            ...
                                            if ($status == 0) {
                                                echo '<span class="badge badge-linesuccess">Active</span>';
                                            }else{
                                                echo '<span class="badge badge-linedanger">In-active</span>';
                                            }
                                            @endphp
                                        </td>
                                        <td>19 Jan 2023</td>
                                        <td>
                                            @php
                                            $login_check = $record->login_checked;
                                            if ($login_check == 0) {
                                                echo '<span class="badge badge-linesuccess">Active</span>';
                                    ...
                                    <td>
                                        <div class="userimgname">
                                            <a href="javascript:void(0);" class="userslist-img">
                                                <img src="{{ url('public/img/users/user-15.jpg') }}" alt="product">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="userimgname">
                                            <a href="javascript:void(0);" class="userslist-img bg-img">
                                                <img src="{{ url('public/img/users/user-16.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="userimgname">
                                            <a href="javascript:void(0);" class="userslist-img">
                                                <img src="{{ url('public/img/users/user-17.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="userimgname">
                                            <a href="javascript:void(0);" class="userslist-img bg-img">
                                                <img src="{{ url('public/img/users/user-18.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="userimgname">
                                            <a href="javascript:void(0);" class="userslist-img bg-img">
                                                <img src="{{ url('public/img/users/user-19.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="userimgname">
                                            <a href="javascript:void(0);" class="userslist-img">
                                                <img src="{{ url('public/img/users/user-20.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="userimgname">
                                            <a href="javascript:void(0);" class="userslist-img">
                                                <img src="{{ url('public/img/users/user-06.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="userimgname">
                                            <a href="javascript:void(0);" class="userslist-img bg-img">
                                                <img src="{{ url('public/img/users/user-21.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="userimgname">
                                            <a href="javascript:void(0);" class="userslist-img">
                                                <img src="{{ url('public/img/users/user-22.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div>
