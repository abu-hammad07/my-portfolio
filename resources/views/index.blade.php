...
<body>
                        ...
                        <div class="banner-comments">
                            ...
                            <div class="banner-carousel owl-carousel">
                                <div class="banner-single-carousel">
                                    <!-- <p><a href="mailto:support@hammadkamal.com">support@hammadkamal.com</a></p> -->
                                    <p>info@hammadkamal.com</p>
                                </div>
                                <div class="banner-single-carousel">
                                    <!-- <p><a href="">+92 313 1192139</a></p> -->
                                    <p>+92 313 1192139</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-7 text-right align-self-center">
                        <div class="banner-social-wrap">
                            <div class="banner-social">
                                <ul>
                                    <li>
                                        <a href="https://www.facebook.com/abu.hammad23" target="_blank">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.linkedin.com/in/abu-hammad/" target="_blank">
                                            <i class="fab fa-linkedin-in"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://github.com/abu-hammad07" target="_blank">
        ...
        <div class="header-area header-main" id="header">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-6 col-lg-3 align-self-center">
                        <a href="index.html" class="logo"><img src="{{ url('public/assets/img/logo/logo.png')}}" alt=""></a>
                    </div>
                    ...
                    <div class="d-none d-lg-block col-lg-3 align-self-center text-right">
                        <div class="search-area">
                            ...
                            <div class="grid-menu" id="grid-side">
                                <img src="{{ url('public/assets/img/icon/hamburger.svg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="slide-widgest-wrap" id="slide-widgest">
                <div class="side-widgest" id="side-content">
                    ...
                    <div class="logo">
                        <a href="#"><img src="{{ url('public/assets/img/logo/logo.png')}}" alt=""></a>
                    </div>
                        ...
                        <div class="logos owl-carousel">
                            <div class="single-logo-table">
                                <div class="single-logo-table-cell">
                                    <img src="{{ url('public/assets/img/logo/1.svg')}}" alt="">
                                </div>
                            </div>
                            <div class="single-logo-table">
                                <div class="single-logo-table-cell">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 m-auto text-center">
                        ...
                        <div class="space-40"></div>
                        <div class="copyright">
                            <p>Copyright © 2024 <span> Abu Hammad </span></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--:::::jquery 3.2.1 js :::::::-->
    <script src="{{ url('public/assets/js/plugins/jQuery.2.1.0.min.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/bootstrap.min.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/jquery.nav.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/jquery.waypoints.min.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/jquery-modal-video.min.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/stellarnav.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/popper.min.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/owl.carousel.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/wow.min.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/easypiechart.min.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/animatenumber.min.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/circle-progress.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/bars.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/appear.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/jquery.hoverdir.js')}}"></script>
    <script src="{{ url('public/assets/js/plugins/isotop.v3.0.4.min.js')}}"></script>
...
<!-- Mirrored from quomodosoft.com/html/glint/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Nov 2024 17:23:53 GMT -->
