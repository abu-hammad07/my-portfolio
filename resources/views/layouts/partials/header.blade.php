...
<div class="header">
    ...
    <div class="header-left active">
        ...
        <a href="{{ url('dashboard') }}" class="logo-small">
            {{--  <img src="{{ url('public/img/logo-small.png') }}" alt="">  --}}
            <img src="{{ url('public/assets/img/abu-hammad.png') }}" alt="">
        </a>
    ...
    <ul class="nav user-menu">
                            ...
                            <ul class="customers">
                                <li>
                                    <a href="javascript:void(0);">Aron Varu<img
                                            src="{{ url('public/img/profiles/avator1.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">Jonita<img
                                            src="{{ url('public/img/profiles/avatar-01.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">Aaron<img
                                            src="{{ url('public/img/profiles/avatar-10.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                </li>
                            </ul>
                        </div>
        ...
        {{--  <li class="nav-item dropdown has-arrow main-drop select-store-dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link select-store" data-bs-toggle="dropdown">
                <span class="user-info">
                    <span class="user-letter">
                        <img src="{{ url('public/img/store/store-01.png') }}" alt="Store Logo" class="img-fluid">
                    </span>
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ url('public/img/store/store-02.png') }}" alt="Store Logo" class="img-fluid">
                    Grocery Apex
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ url('public/img/store/store-03.png') }}" alt="Store Logo" class="img-fluid">
                    Grocery Bevy
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ url('public/img/store/store-04.png') }}" alt="Store Logo" class="img-fluid">
                    Grocery Eden
                </a>
            </div>
        </li>  --}}
        ...
        {{--  <li class="nav-item dropdown has-arrow flag-nav nav-item-box">
            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
                <img src="{{ url('public/img/flags/us.png') }}" alt="Language" class="img-fluid">
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ url('public/img/flags/fr.png') }}" alt="" height="16"> French
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ url('public/img/flags/es.png') }}" alt="" height="16"> Spanish
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ url('public/img/flags/de.png') }}" alt="" height="16"> German
                </a>
            </div>
        </li>  --}}
        <!-- /Flag -->
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                <span class="user-info">
                    <span class="user-letter">
                        <img src="{{ url('public/img/profiles/avator1.jpg') }}" alt="" class="img-fluid">
                    </span>
                    <span class="user-detail">
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    <div class="profileset">
                        <span class="user-img"><img src="{{ url('public/img/profiles/avator1.jpg') }}"
                                alt="">
                    ...
                    <a class="dropdown-item logout pb-0" href="{{ route('logout') }}"><img
                            src="{{ url('public/img/icons/log-out.svg') }}" class="me-2" alt="img">Logout</a>
                </div>
            </div>
        </li>
    </ul>
